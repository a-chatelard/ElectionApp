...
When le vainqueur du scrutin est déterminé
Then le message 'Les candidats Deuxième et Premier passent au deuxième tour.' est affiché
...
And le candidat Premier avec 50 votes
When le vainqueur du scrutin est déterminé
Then le message 'Aucun vainqueur pour ce scrutin.' est affiché 
...
Scenario: Égalité du deuxième et troisième candidat au premier tour
Given un scrutin clôturé
And le tour numéro 1
And le candidat Deuxième avec 25 votes
And le candidat Premier avec 50 votes
...
Scenario: Vote blanc vainqueur au premier tour
Given un scrutin clôturé
And le tour numéro 1
And le candidat Premier avec 40 votes
And 50 votes blanc
...
Scenario: Vote blanc vainqueur au deuxième tour
Given un scrutin clôturé
And le tour numéro 2
And le candidat Premier avec 40 votes
And 50 votes blanc
...
Scenario: Vote blanc non vainqueur au deuxième tour
Given un scrutin clôturé
And le tour numéro 2
And le candidat Premier avec 50 votes
And 40 votes blanc
